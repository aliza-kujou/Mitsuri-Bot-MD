// Codigo creado por Félix OFC https://GitHub.com/mantis-has 
...
userData.message3++  
motive = `᥀·࣭࣪̇˖🙂‍↔️◗ Serás eliminado(𝙖) Por hacer spam.`
await conn.reply(m.chat, motive, m, { mentions: [m.sender] }) 
user.messageSpam = motive
...
const warningMessage = `Mucho Spam ${mention}`
